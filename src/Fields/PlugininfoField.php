...
namespace Joomla\Plugin\Task\Wt_jshopping_b24_pro_cron\Fields;
...
class PlugininfoField extends NoteField
{
	...
	protected function getLabel()
	{
		...
		$wtb24_plugin_info = simplexml_load_file(JPATH_SITE . "/plugins/task/wt_jshopping_b24_pro_cron/wt_jshopping_b24_pro_cron.xml");
		...
		<div class="card container shadow-sm w-100 p-0">
			<div class="wt-b24-plugin-info row">
				...
				<div class="col-10">
					...
					<div class="card-body">
						' . Text::_($wtb24_plugin_info->description) . '
					</div>
